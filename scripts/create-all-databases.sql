-- ============================================================================
-- SCRIPT UNIQUE POUR PGADMIN - TOUT EN UN
-- Exécutez ce script section par section dans pgAdmin
-- ============================================================================

-- ============================================================================
-- ÉTAPE 1 : Exécuter cette partie en tant que superutilisateur (postgres)
-- ============================================================================

-- Créer les utilisateurs (si n'existent pas)
DO $$
BEGIN
    ...
    END IF;
    IF NOT EXISTS (SELECT FROM pg_catalog.pg_user WHERE usename = 'validation_user') THEN
        CREATE USER validation_user WITH PASSWORD 'validation_password';
    END IF;
    IF NOT EXISTS (SELECT FROM pg_catalog.pg_user WHERE usename = 'finance_user') THEN
...
-- ============================================================================
-- ÉTAPE 2 : Se connecter à 'auth_db' dans pgAdmin et exécuter cette partie
-- ============================================================================
...
-- ============================================================================
-- ÉTAPE 3 : Se connecter à 'project_db' dans pgAdmin et exécuter cette partie
-- ============================================================================
...
-- ============================================================================
-- ÉTAPE 4 : Se connecter à 'validation_db' dans pgAdmin et exécuter cette partie
-- ============================================================================
...
-- ============================================================================
-- ÉTAPE 5 : Se connecter à 'finance_db' dans pgAdmin et exécuter cette partie
-- ============================================================================
...
-- ============================================================================
-- VÉRIFICATION (optionnel - à exécuter dans chaque base)
-- ============================================================================
